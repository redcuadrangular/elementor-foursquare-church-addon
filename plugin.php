<?php
namespace FoursquareChurch;

use FoursquareChurch\PageSettings\Page_Settings;
...
class Plugin {
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/foursquare-church.php' );
		require_once( __DIR__ . '/widgets/inline-editing.php' );

		// Register Widgets
		$widgets_manager->register( new Widgets\Foursquare_Church() );
